...
<body class="bg-gray-200 min-h-screen flex flex-col items-center justify-center">
    <div class="neumorphism w-full max-w-xs p-6 text-center mb-6">
        ...
        ?>
        <p class="text-gray-600 text-sm">pagina de firma de facturas</p>
    </div>
...
<div class="modal fade" id="drawSignatureModal" tabindex="-1" aria-labelledby="drawSignatureModalLabel" aria-hidden="true">
    ...
    <nav class="fixed bottom-0 left-0 right-0 bg-white shadow-lg">
        <div class="flex justify-around py-2">
            ...
            <a href="../views/paginaPrincipal.php" class="text-gray-500 text-center flex flex-col items-center">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                    class="w-6 h-6">
