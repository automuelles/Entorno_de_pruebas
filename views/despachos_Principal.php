...
if (!$usuario || !in_array($usuario['rol'], ['Admin', 'Despachos'])) {
...
<body class="bg-gray-200 min-h-screen flex flex-col items-center justify-center">
    ...
    <div class="neumorphism w-full max-w-xs p-6 text-center mb-6">
        ...
        ?>
        <p class="text-gray-600 text-sm">Area de Despachos</p>
    </div>
    ...
    <div class="w-full max-w-xs">
        ...
        <div class="grid grid-cols-3 gap-4">
            <div class="neumorphism p-4 text-center">
                ...
                <a href="./RevisarPedidoDespachos.php" class="text-sm text-gray-700 hover:underline">Revisar Pedido</a>
            </div>
            <div class="neumorphism p-4 text-center">
                <!-- Icono-->
                <div
