<?php
include '../app/controllers/picking.php'; 
?>
    ...
    ?>
        ...
        <div class="d-flex justify-content-between mt-3">
            <div class="d-flex w-100">
                <form action="../app/controllers/picking.php" method="post" class="w-50 mr-2">
                ...
                <a href="./separar_pedido.php" class="btn btn-secondary btn-block w-50 ml-2">Volver</a>
            </div>
        </div>
    </div>
    <!-- Footer Navigation -->
     ...
     <script>
        function confirmSepararPedido(transaccion, documento) {
            if (confirm('¿Está seguro de que desea separar el pedido?')) {
                ...
                window.location.href = `./revision.php?transaccion=${encodeURIComponent(transaccion)}&documento=${encodeURIComponent(documento)}`;
            }
        }
    </script>
</body>
