<?php
include '../app/controllers/ComenzarRevisionDespachos.php'; 
?>
    ...
    ?>
        ...
        <div class="d-flex justify-content-between mt-3">
            <div class="d-flex w-100">
                <form action="../app/controllers/ComenzarRevisionDespachos.php" method="post" class="w-50 mr-2">
     ...
     <script>
        function confirmSepararPedido(transaccion, documento) {
            if (confirm('¿Está seguro de que desea separar el pedido?')) {
                ...
                window.location.href = `./finalizarRevisionDespachos.php?transaccion=${encodeURIComponent(transaccion)}&documento=${encodeURIComponent(documento)}`;
            }
        }
    </script>
</body>
