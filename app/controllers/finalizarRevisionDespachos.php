...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $sqlUpdate = "UPDATE Facturas SET Estado = 'RevisionDespachosFinalizada' WHERE IntTransaccion = ? AND IntDocumento = ?";
        ...
        $estadoActual = 'RevisionDespachosFinalizada';
        ...
        echo "<script>
            ...
            window.location.href = '../views/RevisarPedidoDespachos.php';
        </script>";
        exit();
    } catch (Exception $e) {
