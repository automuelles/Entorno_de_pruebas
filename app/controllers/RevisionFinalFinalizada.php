...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $sqlUpdate = "UPDATE Facturas SET Estado = 'RevisionFinalFinalizada' WHERE IntTransaccion = ? AND IntDocumento = ?";
        ...
        $estadoActual = 'RevisionFinalFinalizada';
        ...
        echo "<script>
            ...
            window.location.href = '../views/revision_final.php?transaccion={$transaccion}&documento={$documento}';
        </script>";
        exit();
    } catch (Exception $e) {
