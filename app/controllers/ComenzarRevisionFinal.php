...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $sqlUpdate = "UPDATE Facturas SET Estado = 'RevisionFinalComenzada' WHERE IntTransaccion = ? AND IntDocumento = ?";
        ...
        $estadoActual = 'RevisionFinalComenzada';
        ...
        echo "<script>
            alert('Estado actualizado a \"RevisionFinalComenzada\" y registro guardado en la tabla \"estados\"');
            window.location.href = '../../views/RevisionFinalFinalizada.php?transaccion={$transaccion}&documento={$documento}';
        </script>";
    } catch (Exception $e) {
