...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $sqlUpdate = "UPDATE Facturas SET Estado = 'RevisionComenzadaDespachos' WHERE IntTransaccion = ? AND IntDocumento = ?";
        ...
        $estadoActual = 'RevisionComenzadaDespachos';
        ...
        echo "<script>
            ...
            window.location.href = '../../views/finalizarRevisionDespachos.php?transaccion={$transaccion}&documento={$documento}';
        </script>";
    } catch (Exception $e) {
